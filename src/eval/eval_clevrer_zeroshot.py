...
class ModelEvaluator:
    def __init__(
        ...
        # Question template
        self.question_template = "{Question} Output the final answer (letters separated by , if multiple) in <answer> </answer> tags directly. "
...
def evaluate(model_name, batch_size):
    ...
    try:
        ...
        dataset_path = os.path.join(private_data_root, "CLVERER", f"{dataset_name}.json")
